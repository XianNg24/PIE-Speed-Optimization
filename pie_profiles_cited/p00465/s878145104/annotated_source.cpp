// === HOTSPOT FILE-LEVEL SUMMARY (per gprof) ===
// No user-defined function appears in the flat profile, but most runtime is spent in:
//   - 100.0% in std::__detail::_List_node_header::_M_init, 250054 calls
// Consider whether the data structures or I/O routines you use here are the right ones.
